...
public class OOP3 {
  public static void main(String args[]) {
    ...
    //Square sq1 = new Square("black", 2);   // ->> This is right we create object by child class
    shape sq1 = new Square("black", 2);  //This is also right since child is a parent
    //Triangle sq1 = new Square("black", 2);    //But this is wrong since both triangle and Square are inherited from shape /////Siblings X//// //Parents-Child O/// 
    sq1.display();
